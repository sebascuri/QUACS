"""autogenerated by genpy from ardrone_sensorfusion/Navdata.msg. Do not edit."""
import sys
...
class Navdata(genpy.Message):
  _md5sum = "36a3b7435300a70664e2279389dec253"
  _type = "ardrone_sensorfusion/Navdata"
...
float64 z
"""
  __slots__ = ['header','pose','twist','acceleration']
  _slot_types = ['std_msgs/Header','geometry_msgs/PoseWithCovariance','geometry_msgs/TwistWithCovariance','geometry_msgs/TwistWithCovariance']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose,twist,acceleration
